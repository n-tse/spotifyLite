...
const mongoose = require("mongoose"); // mongoose is an ODM/library that allows us to interact with MongoDB. Mongoose provides a lot of methods we can call to access and change contents of mongodb database. 
